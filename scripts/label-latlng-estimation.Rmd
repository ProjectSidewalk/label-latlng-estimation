...
# NOTE (2026-08-05): the data/*.csv files this Rmd read were never committed and the originals
# are lost. The repo now carries data/labels-*-latlng.csv.gz — a RECONSTRUCTION extracted from
# production (see data/MANIFEST.md and issue #1) — which reproduces this analysis' published row
# counts (395,147 cleaned) and findings exactly (see tests/ and scripts/rerun-analysis.R). To
# knit this Rmd against it, gunzip those files first (or append .gz to the paths below; readr
# reads gzip transparently). This Rmd is otherwise unchanged as the frozen 2021 record; the
# Python port in python/ is the authoritative implementation going forward (issue #2).
